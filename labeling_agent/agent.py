...
CATEGORIES = [
    ...
    {"id": "student-visas", "name": "Student Visas (F-1/OPT/STEM OPT)", "description": "F-1 student visa, M-1 vocational, OPT, STEM OPT extension, CPT, SEVP, maintaining status, transfers"},
    ...
    {"id": "diversity-visa-lottery", "name": "Diversity Visa Lottery", "description": "DV lottery entry, selectee processing, qualifying countries, photo requirements, interview"},
    ...
    {"id": "consular-processing", "name": "Consular Processing", "description": "National Visa Center, DS-260, interview preparation, visa issuance, 221(g) administrative processing, medical exam"},
    {"id": "adjustment-of-status", "name": "Adjustment of Status", "description": "I-485 application, concurrent filing, interview waiver, employment authorization while pending, travel while pending"},
    {"id": "travel-documents", "name": "Travel Documents", "description": "Advance parole, re-entry permits, refugee travel documents, emergency travel, maintaining status while traveling"},
    ...
    {"id": "general-immigration-info", "name": "General Immigration Info", "description": "Overview content, immigration glossaries, general resources, forms index, processing times, case status"},
]
