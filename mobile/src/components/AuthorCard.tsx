...
const styles = StyleSheet.create({
  ...
  heading: { fontFamily: 'NunitoSans_600SemiBold', fontSize: 15, color: colors.onSurface },
  viewProfile: { fontFamily: 'NunitoSans_600SemiBold', fontSize: 12, color: colors.secondary },
  anonRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  anonText: { fontFamily: 'NunitoSans_400Regular', fontSize: 14, color: colors.onSurfaceVariant },
  muted: { fontFamily: 'NunitoSans_400Regular', fontSize: 13, color: colors.onSurfaceVariant },
  body: { gap: spacing.base },
  username: { fontFamily: 'NunitoSans_700Bold', fontSize: 16, color: colors.onSurface },
  section: { gap: 4 },
  sectionLabel: { fontFamily: 'NunitoSans_600SemiBold', fontSize: 11, textTransform: 'uppercase', color: colors.onSurfaceVariant, letterSpacing: 0.4 },
  ...
  chipText: { fontFamily: 'NunitoSans_600SemiBold', fontSize: 11, color: colors.onSurfaceVariant },
  chipTextPrimary: { color: colors.onPrimaryContainer },
  chipTextSecondary: { color: colors.onSecondaryContainer },
  kv: { fontFamily: 'NunitoSans_400Regular', fontSize: 13, color: colors.onSurface },
  ...
  postingItem: { gap: 4 },
  postingTitle: { fontFamily: 'NunitoSans_600SemiBold', fontSize: 14, color: colors.onSurface },
  postingMeta: { flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', gap: 5 },
  postingDate: { fontFamily: 'NunitoSans_400Regular', fontSize: 11, color: colors.onSurfaceVariant },
});
