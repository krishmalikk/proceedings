// Gemini AI Service for meridianjourney.ai
...
const SYSTEM_PROMPT = `You are meridianjourney.ai AI, a helpful assistant for US immigration questions. You help users:
...
export async function startChat(): Promise<void> {
  ...
  chatSession = model.startChat({
    history: [
      {
        role: 'user',
        parts: [{ text: 'You are meridianjourney.ai AI assistant. Follow these instructions: ' + SYSTEM_PROMPT }],
      },
      {
        role: 'model',
        parts: [{ text: 'I understand. I\'m meridianjourney.ai AI, ready to help with US immigration questions, searching experiences, and drafting posts. How can I assist you today?' }],
      },
    ],
    generationConfig: {
