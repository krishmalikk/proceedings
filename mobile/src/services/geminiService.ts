// Gemini AI Service for Meridian
...
const SYSTEM_PROMPT = `You are Meridian AI, a helpful assistant for US immigration questions. You help users:
...
parts: [{ text: 'You are Meridian AI assistant. Follow these instructions: ' + SYSTEM_PROMPT }],
      ...
      {
        role: 'model',
        parts: [{ text: 'I understand. I\'m Meridian AI, ready to help with US immigration questions, searching experiences, and drafting posts. How can I assist you today?' }],
      },
    ],
    generationConfig: {
