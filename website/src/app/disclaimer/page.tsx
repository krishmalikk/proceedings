...
export const metadata: Metadata = {
  ...
  description:
    'Proceedings provides general immigration information and a community platform only. It is not a law firm and does not provide legal advice.',
}
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 text-body-md text-on-surface-variant leading-relaxed">
          <p className="text-body-md text-on-surface">
            Please read this disclaimer carefully before using Proceedings (the
          ...
          <section>
            ...
            <p>
              ...
              Proceedings, its owners, operators, employees, contributors, or any other user.
          ...
          <section>
            ...
            <p>
              ...
              experiences of the individuals who posted it. Proceedings does not author, verify,
          ...
          <section>
            ...
            <p>
              Proceedings is not a law firm, is not a substitute for an attorney or law firm, and
              does not practice law. Proceedings is not affiliated with, endorsed by, or acting on
          ...
          <section>
            ...
            <p>
              To the fullest extent permitted by law, Proceedings and its owners, operators,
          ...
          <div className="divider pt-6">
            <p className="text-caption text-on-surface-variant">
              ...
              <a href="mailto:support@proceedings.app" className="text-primary hover:underline">
                support@proceedings.app
              </a>
              .
            </p>
          </div>
