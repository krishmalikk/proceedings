...
// excluded — only the real "TERMS OF USE" agreement is rendered here.
...
const PREAMBLE: Block[] = [
  h3('Agreement to Our Legal Terms'),
  p('We are Krishes Inc ("Company," "we," "us," "our"), a company registered in California, United States at 2195 Carbondale Cir, Dublin, CA 94568.'),
  p('We operate the website https://www.meridianjourney.ai (the "Site"), the mobile application Meridian Journey (the "App"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").'),
  p('Get help or support for Non-Immigration and Immigration process of United States'),
  p('You can contact us by phone at (+1)5084467058, email at krishesinc@gmail.com, or by mail to 2195 Carbondale Cir, Dublin, CA 94568, United States.'),
  p('These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and Krishes Inc, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.'),
  ...
  p('The Services are intended for users who are at least 18 years old. Persons under the age of 18 are not permitted to use or register for the Services.'),
...
const SECTIONS: { heading: string; blocks: Block[] }[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      h3('Your submissions and contributions'),
      ...
      p('You understand that Contributions may be viewable by other users of the Services and possibly through third-party websites.'),
      ...
      p('This license includes our use of your name, company name, and franchise name, as applicable, and any of the trademarks, service marks, trade names, logos, and personal and commercial images you provide.'),
      ...
      p('You are solely responsible for your Submissions and/or Contributions and you expressly agree to reimburse us for any and all losses that we may suffer because of your breach of (a) this section, (b) any third party’s intellectual property rights, or (c) applicable law.'),
      ...
      p('We respect the intellectual property rights of others. If you believe that any material available on or through the Services infringes upon any copyright you own or control, please immediately refer to the "COPYRIGHT INFRINGEMENTS" section below.'),
    ],
  },
  {
  ...
  {
    heading: '6. User Generated Contributions',
    blocks: [
  ...
  {
    heading: '7. Contribution License',
    blocks: [
  ...
  {
    heading: '8. Mobile Application License',
    blocks: [
      h3('Use License'),
  ...
  {
    heading: '9. Third-Party Websites and Content',
    blocks: [
  ...
  },
  {
    ...
    blocks: [
      p('We care about data privacy and security. Please review our Privacy Policy: meridianjourney.ai/privacy. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.'),
    ],
  },
  {
    heading: '13. Copyright Infringements',
    blocks: [
  ...
  {
    heading: '24. California Users and Residents',
    blocks: [
  ...
  },
  {
    ...
    blocks: [
      ...
      p('Krishes Inc'),
      p('2195 Carbondale Cir'),
      p('Dublin, CA 94568'),
      p('United States'),
      p('Phone: (+1)5084467058'),
      p('krishesinc@gmail.com'),
    ],
  },
]
  ...
  return (
    <div className="container-narrow section-padding-sm">
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="text-headline-lg text-on-surface mb-1">Terms of Use</h1>
        ...
        <div className="space-y-6 text-body-md text-on-surface-variant leading-relaxed">
          {/* Preamble */}
          <section>{renderBlocks(PREAMBLE)}</section>

          {/* Table of contents */}
          <section>
            <h2 className="text-headline-md text-on-surface mb-2">Table of Contents</h2>
