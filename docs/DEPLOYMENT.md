...
| `APP_SOURCE_SYSTEM` | first-party **provenance** id; default `usajourney` (D-055; registered domain) |
| `APP_BASE_URL` | base URL for `source_url`/`source_uri`/`full_url`; default `https://usajourney.ai` |
